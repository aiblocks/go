# Millennium Protocol Changelog

Any changes to the Millennium Public API should be included in this doc.
...
- [JS SDK 0.10.2](https://github.com/aiblocks/js-aiblocks-sdk/releases/tag/v0.10.2)
- [Java SDK 0.4.0](https://github.com/aiblocks/java-aiblocks-sdk/releases/tag/0.4.0)
...
* In ["Offers for Account"](https://www.aiblocks.io/developers/millennium/reference/endpoints/offers-for-account.html),
`last_modified_time` field  endpoint can be `null` when ledger data is not available (has not been ingested yet).
* ["Trades for Offer"](https://www.aiblocks.io/developers/millennium/reference/endpoints/trades-for-offer.html) endpoint
will query for trades that match the given offer on either side of trades, rather than just the "sell" offer.
Offer IDs are now [synthetic](https://www.aiblocks.io/developers/millennium/reference/resources/trade.html#synthetic-offer-ids).
...
* In ["Trade Aggregations"](https://www.aiblocks.io/developers/millennium/reference/endpoints/trade_aggregations.html) endpoint,
...
- [JS SDK 0.10.2](https://github.com/aiblocks/js-aiblocks-sdk/releases/tag/v0.10.2)
- [Java SDK 0.3.1](https://github.com/aiblocks/java-aiblocks-sdk/releases/tag/0.3.1)
...
* Millennium now sends `Cache-Control: no-cache, no-store, max-age=0` HTTP header for all responses.
...
- [JS SDK 0.8.2](https://github.com/aiblocks/js-aiblocks-sdk/releases/tag/v0.8.2)
- [Java SDK 0.2.1](https://github.com/aiblocks/java-aiblocks-sdk/releases/tag/0.2.1)
