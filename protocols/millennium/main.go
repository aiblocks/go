// Package millennium contains the type definitions for all of millennium's
// response resources.
package millennium
...
import (
	...
	"github.com/aiblocks/go/protocols/millennium/base"
...
// GetAccountID returns the AiBlocks account ID. This is to satisfy the
...
type Ledger struct {
	...
	BaseFee                    int32     `json:"base_fee_in_sectors"`
	BaseReserve                int32     `json:"base_reserve_in_sectors"`
...
type Root struct {
	...
	MillenniumVersion               string `json:"millennium_version"`
	AiBlocksCoreVersion           string `json:"core_version"`
...
// Trade represents a millennium digested trade
type Trade struct {
	Links struct {
		Self      hal.Link `json:"self"`
...
// AssetsPage contains page of assets returned by Millennium.
...
// LedgersPage contains page of ledger information returned by Millennium
...
// FeeStats represents a response of fees from millennium
// To do: implement fee suggestions if agreement is reached in https://github.com/aiblocks/go/issues/926
...
// TransactionsPage contains records of transaction information returned by Millennium
...
// PathsPage contains records of payment paths found by millennium
