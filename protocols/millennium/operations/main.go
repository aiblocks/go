...
// in millennium's JSON responses
...
type Base struct {
	...
	Transaction     *millennium.Transaction `json:"transaction,omitempty"`
...
type CreateClaimableBalance struct {
	...
	Amount    string             `json:"amount"`
	Claimants []millennium.Claimant `json:"claimants"`
}
