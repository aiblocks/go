# Ticker
This project aims to provide an easy-to-deploy AiBlocks ticker.
...
2. Clone the [monorepo](https://github.com/aiblocks/go)
...
2. Run the ticker with the mounted folder: `$ docker run --rm -it -p "8000:8000" -v
   "/path/to/data/folder:/opt/aiblocks/postgresql" ticker` (you'll also be asked to enter a
