...
// reading rows from a the history portion of millennium's database
package history
...
// Offer is row of data from the `offers` table from millennium DB
type Offer struct {
...
// portion of the millennium database.
type Q struct {
	*db.Session
}
...
// TrustLine is row of data from the `trust_lines` table from millennium DB
