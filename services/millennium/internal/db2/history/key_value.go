...
const (
	...
	// Distributed ingestion in Millennium relies on this key and it is part
...
// This is used in status reporting (ex. in root resource of Millennium).
...
// in Millennium. Returns ErrKeyNotFound error if no value has been previously set.
