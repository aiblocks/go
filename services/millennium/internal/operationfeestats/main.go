...
// stats within aiblocks,specifically as a central location to store a cached snapshot
...
// State represents a snapshot of millennium's view of the state of operation fee's
// on the network.
type State struct {
	FeeChargedMax  int64
	FeeChargedMin  int64
