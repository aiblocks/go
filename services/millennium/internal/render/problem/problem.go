...
var (
	...
	ServerOverCapacity = problem.P{
		...
		Status: http.StatusServiceUnavailable,
		Detail: "This millennium server is currently overloaded.  Please wait for " +
	...
	BeforeHistory = problem.P{
		...
		Detail: "This millennium instance is configured to only track a " +
			"portion of the aiblocks network's latest history. This request " +
			"is asking for results prior to the recorded history known to " +
			"this millennium instance.",
	}
	...
	StaleHistory = problem.P{
		...
		Status: http.StatusServiceUnavailable,
		Detail: "This millennium instance is configured to reject client requests " +
			"when it can determine that the history database is lagging too far " +
			"behind the connected instance of aiblocks-core.  If you operate this " +
