...
func TestActionGetPageQuery(t *testing.T) {
	...
	// regression: https://github.com/aiblocks/go/services/millennium/internal/issues/372
...
func TestGetURLParam(t *testing.T) {
	...
	// Regression for https://github.com/aiblocks/go/issues/1965
...
func makeTestActionRequest(path string, body map[string]string) *http.Request {
	...
	return r.WithContext(context.WithValue(ctx, &millenniumContext.RequestContextKey, r))
}
