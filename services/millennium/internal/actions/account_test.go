	...
	account2 = xdr.LedgerEntry{
		...
		Data: xdr.LedgerEntryData{
			...
			Account: &xdr.AccountEntry{
				...
				NumSubEntries: 10,
				Flags:         2,
				HomeDomain:    "meridian.aiblocks.io",
...
func TestAccountInfo(t *testing.T) {
	...
	account, err := AccountInfo(tt.Ctx, &history.Q{tt.MillenniumSession()}, accountID.Address())
	tt.Assert.NoError(err)
	...
	_, err = AccountInfo(tt.Ctx, &history.Q{tt.MillenniumSession()}, "GDBAPLDCAEJV6LSEDFEAUDAVFYSNFRUYZ4X75YYJJMMX5KFVUOHX46SQ")
