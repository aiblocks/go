...
type System struct {
	...
	DB                func(context.Context) MillenniumDB
...
func (sys *System) waitUntilAccountSequence(ctx context.Context, db MillenniumDB, sourceAddress string, seq uint64) bool {
...
func (sys *System) Init() {
	sys.initializer.Do(func() {
		...
		if sys.SubmissionTimeout == 0 {
			...
			// timeout.
			// 30 seconds is 6 ledgers (with avg. close time = 5 sec), enough for aiblocks-core
