// Package txsub provides the machinery that millennium uses to submit transactions to
// the aiblocks network and track their progress.  It also helps to hide some of the
