...
func txResultByHash(db MillenniumDB, hash string) (history.Transaction, error) {
...
// is ingested.
func checkTxAlreadyExists(db MillenniumDB, hash, sourceAddress string) (history.Transaction, uint64, error) {
