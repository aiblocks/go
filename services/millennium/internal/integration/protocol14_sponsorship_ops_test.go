...
import (
	...
	"github.com/aiblocks/go/services/millennium/internal/test/integration"
...
func TestSponsorships(t *testing.T) {
	...
	t.Run("PreAuthSigner", func(t *testing.T) {
		...
		// See https://github.com/aiblocks/go/pull/3050#discussion_r493651644
	})
	...
	t.Run("ClaimableBalance", func(t *testing.T) {
		...
		masterBalance := getAccountDLO(itest, sponsorPair)
		...
		tt.Lessf(getAccountDLO(itest, sponsoreePair), float64(25), "sponsoree balance didn't decrease")
		tt.Greaterf(getAccountDLO(itest, sponsorPair), masterBalance, "master balance didn't increase")
...
// Retrieves the DLO balance for an account.
func getAccountDLO(i *integration.Test, account *keypair.Full) float64 {
