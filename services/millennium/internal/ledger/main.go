// Package ledger provides useful utilities concerning ledgers within aiblocks,
// specifically as a central location to store a cached snapshot of the state of
// both millennium's and aiblocks-core's views of the ledger.  This package is
// intended to be at the lowest levels of millennium's dependency tree, please keep
// it free of dependencies to other millennium packages.
package ledger
...
// State represents a snapshot of both millennium's and aiblocks-core's view of the
// ledger.
type State struct {
