...
// New creates a new logger according to millennium specifications.
...
func NewMetrics() *Metrics {
	return &Metrics{
		logrus.DebugLevel: prometheus.NewCounter(prometheus.CounterOpts{
			Namespace: "millennium", Subsystem: "log", Name: "debug_total",
		}),
		logrus.InfoLevel: prometheus.NewCounter(prometheus.CounterOpts{
			Namespace: "millennium", Subsystem: "log", Name: "info_total",
		}),
		logrus.WarnLevel: prometheus.NewCounter(prometheus.CounterOpts{
			Namespace: "millennium", Subsystem: "log", Name: "warn_total",
		}),
		logrus.ErrorLevel: prometheus.NewCounter(prometheus.CounterOpts{
			Namespace: "millennium", Subsystem: "log", Name: "error_total",
		}),
		logrus.PanicLevel: prometheus.NewCounter(prometheus.CounterOpts{
			Namespace: "millennium", Subsystem: "log", Name: "panic_total",
		}),
	}
}
