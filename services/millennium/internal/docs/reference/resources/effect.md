---
title: Effect
replacement: https://developers.aiblocks.io/api/resources/effects/
---
...
directly reflected in the [ledger](https://www.aiblocks.io/developers/learn/concepts/ledger.html) or [history](https://github.com/aiblocks/aiblocks-core/blob/master/docs/history.md), as [transactions](https://www.aiblocks.io/developers/learn/concepts/transactions.html) and [operations](https://www.aiblocks.io/developers/learn/concepts/operations.html) are.
...
|--------------------------------------------------------------------------------------------------------------------------------------------|------------|---------------------------------|
| [All Effects](https://github.com/aiblocks/go/blob/master/services/millennium/internal/docs/reference/endpoints/effects-all.md)                 | Collection | `/effects`                      |
| [Operation Effects](https://github.com/aiblocks/go/blob/master/services/millennium/internal/docs/reference/endpoints/effects-for-operation.md) | Collection | `/operations/:id/effects`       |
| [Account Effects](https://github.com/aiblocks/go/blob/master/services/millennium/internal/docs/reference/endpoints/effects-for-account.md)     | Collection | `/accounts/:account_id/effects` |
| [Ledger Effects](https://github.com/aiblocks/go/blob/master/services/millennium/internal/docs/reference/endpoints/effects-for-ledger.md)       | Collection | `/ledgers/:ledger_id/effects`   |
