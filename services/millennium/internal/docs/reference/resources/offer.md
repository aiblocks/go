---
title: Offer
replacement: https://developers.aiblocks.io/api/resources/offers/
---

Accounts on the AiBlocks network can make [offers](http://aiblocks.io/developers/learn/concepts/exchange.html) to buy or sell assets.  Users can create offers with the [Manage Offer](http://aiblocks.io/developers/learn/concepts/list-of-operations.html) operation.

Millennium only returns offers that belong to a particular account.  When it does, it uses the following format:
...
| selling              | [Asset](http://aiblocks.io/developers/learn/concepts/assets.html) | The Asset this offer wants to sell.                                                                                      |
| buying               | [Asset](http://aiblocks.io/developers/learn/concepts/assets.html) | The Asset this offer wants to buy.                                                                                       |
...
```json
{
  "_links": {
    "self": {
      "href": "https://millennium-testnet.aiblocks.io/offers/2611"
    },
    "offer_maker": {
      "href": "https://millennium-testnet.aiblocks.io/accounts/GDG3NOK5YI7A4FCBHE6SKI4L65R7UPRBZUZVBT44IBTQBWGUSTJDDKBQ"
    }
  },
  "id": "2611",
  "paging_token": "2611",
