---
title: Account
replacement: https://developers.aiblocks.io/api/resources/accounts/
---

In the AiBlocks network, users interact using **accounts** which can be controlled by a corresponding keypair that can authorize transactions. One can create a new account with the [Create Account](./operation.md#create-account) operation.

To learn more about the concept of accounts in the AiBlocks network, take a look at the [AiBlocks account concept guide](https://www.aiblocks.io/developers/learn/concepts/accounts.html).

When millennium returns information about an account it uses the following format:
...
| subentry_count | number           | The number of [account subentries](https://www.aiblocks.io/developers/guides/concepts/ledger.html#ledger-entries).                           |
...
| signers        | array of objects | An array of [account signers](https://www.aiblocks.io/developers/guides/concepts/multi-sig.html#additional-signing-keys) with their weights. |
...
| Type               | Description                                                                                                                                                                                                         |
|--------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| ed25519_public_key | A normal AiBlocks public key.                                                                                                                                                                                        |
...
| asset_issuer        | optional, string | The aiblocks address of the given asset's issuer.                                                                                                                                                                                                              |
...
[account_merge]: https://www.aiblocks.io/developers/guides/concepts/list-of-operations.html#account-merge
[allow_trust]: https://www.aiblocks.io/developers/guides/concepts/list-of-operations.html#allow-trust
[bump_seq]: https://www.aiblocks.io/developers/guides/concepts/list-of-operations.html#bump-sequence
[change_trust]: https://www.aiblocks.io/developers/guides/concepts/list-of-operations.html#change-trust
[create_acc]: https://www.aiblocks.io/developers/guides/concepts/list-of-operations.html#create-account
[inflation]: https://www.aiblocks.io/developers/guides/concepts/list-of-operations.html#inflation
[manage_data]: https://www.aiblocks.io/developers/guides/concepts/list-of-operations.html#manage-data
[manage_buy_offer]: https://www.aiblocks.io/developers/guides/concepts/list-of-operations.html#manage-buy-offer
[manage_sell_offer]: https://www.aiblocks.io/developers/guides/concepts/list-of-operations.html#manage-sell-offer
[passive_sell_offer]: https://www.aiblocks.io/developers/guides/concepts/list-of-operations.html#create-passive-sell-offer
[path_payment_receive]: https://www.aiblocks.io/developers/guides/concepts/list-of-operations.html#path-payment-strict-receive
[path_payment_send]: https://www.aiblocks.io/developers/guides/concepts/list-of-operations.html#path-payment-strict-send
[payment]: https://www.aiblocks.io/developers/guides/concepts/list-of-operations.html#payment
[set_options]: https://www.aiblocks.io/developers/guides/concepts/list-of-operations.html#set-options
...
```json
{
  "_links": {
    "self": {
      "href": "https://millennium-testnet.aiblocks.io/accounts/GBWRID7MPYUDBTNQPEHUN4XOBVVDPJOHYXAVW3UTOD2RG7BDAY6O3PHW"
    },
    "transactions": {
      "href": "https://millennium-testnet.aiblocks.io/accounts/GBWRID7MPYUDBTNQPEHUN4XOBVVDPJOHYXAVW3UTOD2RG7BDAY6O3PHW/transactions{?cursor,limit,order}",
      "templated": true
    },
    "operations": {
      "href": "https://millennium-testnet.aiblocks.io/accounts/GBWRID7MPYUDBTNQPEHUN4XOBVVDPJOHYXAVW3UTOD2RG7BDAY6O3PHW/operations{?cursor,limit,order}",
      "templated": true
    },
    "payments": {
      "href": "https://millennium-testnet.aiblocks.io/accounts/GBWRID7MPYUDBTNQPEHUN4XOBVVDPJOHYXAVW3UTOD2RG7BDAY6O3PHW/payments{?cursor,limit,order}",
      "templated": true
    },
    "effects": {
      "href": "https://millennium-testnet.aiblocks.io/accounts/GBWRID7MPYUDBTNQPEHUN4XOBVVDPJOHYXAVW3UTOD2RG7BDAY6O3PHW/effects{?cursor,limit,order}",
      "templated": true
    },
    "offers": {
      "href": "https://millennium-testnet.aiblocks.io/accounts/GBWRID7MPYUDBTNQPEHUN4XOBVVDPJOHYXAVW3UTOD2RG7BDAY6O3PHW/offers{?cursor,limit,order}",
      "templated": true
    },
    "trades": {
      "href": "https://millennium-testnet.aiblocks.io/accounts/GBWRID7MPYUDBTNQPEHUN4XOBVVDPJOHYXAVW3UTOD2RG7BDAY6O3PHW/trades{?cursor,limit,order}",
      "templated": true
    },
    "data": {
      "href": "https://millennium-testnet.aiblocks.io/accounts/GBWRID7MPYUDBTNQPEHUN4XOBVVDPJOHYXAVW3UTOD2RG7BDAY6O3PHW/data/{key}",
      "templated": true
    }
  },
