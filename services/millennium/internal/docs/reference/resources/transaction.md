---
title: Transaction
replacement: https://developers.aiblocks.io/api/resources/transactions/
---

**Transactions** are the basic unit of change in the AiBlocks Network.

A transaction is a grouping of [operations](./operation.md).

To learn more about the concept of transactions in the AiBlocks network, take a look at the [AiBlocks transactions concept guide](https://www.aiblocks.io/developers/learn/concepts/transactions.html).
