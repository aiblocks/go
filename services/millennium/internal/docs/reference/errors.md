---
title: Errors
replacement: https://developers.aiblocks.io/api/errors/
---

In the event that an error occurs while processing a request to millennium, an
...
Like HAL for successful responses, millennium uses a standard to specify how we
communicate errors to the client.  Specifically, millennium uses the [Problem
...
There are a set of errors that can occur in any request to millennium which we
