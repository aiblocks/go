...
Millennium, Millennium will return a `not_implemented` error. Likewise, if functionality that is intended
...
If you are encountering this error, Millennium does not have the functionality you are requesting.

## Attributes

As with all errors Millennium returns, `not_implemented` follows the
...
```shell
$ curl -X GET "https://millennium-testnet.aiblocks.io/offers/1234"
{
  "type": "https://aiblocks.io/millennium-errors/not_implemented",
