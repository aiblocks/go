...
As with all errors Millennium returns, `transaction_failed` follows the
...
| `result_xdr`               | String | A base64-encoded representation of the TransactionResult XDR returned by aiblocks-core when submitting this transaction.     |
| `result_codes.transaction` | String | The transaction result code returned by AiBlocks Core.                                                                       |
