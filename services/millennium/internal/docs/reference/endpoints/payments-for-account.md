...
clientData:
  laboratoryUrl: https://www.aiblocks.io/laboratory/#explorer?resource=payments&endpoint=for_account
replacement: https://developers.aiblocks.io/api/resources/accounts/payments/
---
...
listen for new payments to or from an account as they get made in the AiBlocks network.
If called in streaming mode Millennium will start at the earliest known payment unless a `cursor` is
...
curl "https://millennium-testnet.aiblocks.io/accounts/GCEZWKCA5VLDNRLN3RPRJMRZOX3Z6G5CHCGSNFHEYVXM3XOJMDS674JZ/payments?limit=25&order=desc"
```
