...
clientData:
  laboratoryUrl: https://www.aiblocks.io/laboratory/#explorer?resource=trades&endpoint=for_offer
---

This endpoint represents all [trades](../resources/trade.md) for a given [offer](../resources/offer.md).

This endpoint can also be used in [streaming](../streaming.md) mode, making it possible to listen for new trades for the given offer as they occur on the AiBlocks network.
If called in streaming mode Millennium will start at the earliest known trade unless a `cursor` is set. In that case it will start from the `cursor`. You can also set `cursor` value to `now` to only stream trades created since your request time.
## Request
...
```sh
curl "https://millennium-testnet.aiblocks.io/offers/323223/trades"
```
...
```json
{
  "_links": {
    "self": {
      "href": "https://millennium-testnet.aiblocks.io/offers/323223/trades?cursor=\u0026limit=10\u0026order=asc"
    },
    "next": {
      "href": "https://millennium-testnet.aiblocks.io/offers/323223/trades?cursor=35789107779080193-0\u0026limit=10\u0026order=asc"
    },
    "prev": {
      "href": "https://millennium-testnet.aiblocks.io/offers/323223/trades?cursor=35789107779080193-0\u0026limit=10\u0026order=desc"
    }
  },
  "_embedded": {
    "records": [
      {
        "_links": {
          ...
          "base": {
            "href": "https://millennium-testnet.aiblocks.io/accounts/GDRCFIQAUEFUQ6GXF5DPRO2M77E4UB7RW7EWI2FTKOW7CWYKZCHSI75K"
          },
          "counter": {
            "href": "https://millennium-testnet.aiblocks.io/accounts/GCUD7CBKTQI4D7ZR7IKHMGXZKKVABML7XFBHV4AIYBOEN5UQFZ5DSPPT"
          },
          "operation": {
            "href": "https://millennium-testnet.aiblocks.io/operations/35789107779080193"
          }
        },
