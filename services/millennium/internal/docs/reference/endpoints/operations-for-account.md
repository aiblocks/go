...
clientData:
  laboratoryUrl: https://www.aiblocks.io/laboratory/#explorer?resource=operations&endpoint=for_account
...
```sh
curl "https://millennium-testnet.aiblocks.io/accounts/GA2HGBJIJKI6O4XEM7CZWY5PS6GKSXL6D34ERAJYQSPYA6X6AI7HYW36/operations"
```
