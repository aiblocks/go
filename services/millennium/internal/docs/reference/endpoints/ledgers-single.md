...
clientData:
  laboratoryUrl: https://www.aiblocks.io/laboratory/#explorer?resource=ledgers&endpoint=single
replacement: https://developers.aiblocks.io/api/resources/ledgers/single/
---
...
```sh
curl "https://millennium-testnet.aiblocks.io/ledgers/69859"
```
