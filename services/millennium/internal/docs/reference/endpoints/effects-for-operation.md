...
clientData:
  laboratoryUrl: https://www.aiblocks.io/laboratory/#explorer?resource=effects&endpoint=for_operation
replacement: https://developers.aiblocks.io/api/resources/operations/effects/
---
...
```sh
curl "https://millennium-testnet.aiblocks.io/operations/1919197546291201/effects"
```
...
```json
{
  "_links": {
    "self": {
      "href": "https://millennium-testnet.aiblocks.io/operations/1919197546291201/effects?cursor=&limit=10&order=asc"
    },
    "next": {
      "href": "https://millennium-testnet.aiblocks.io/operations/1919197546291201/effects?cursor=1919197546291201-3&limit=10&order=asc"
    },
    "prev": {
      "href": "https://millennium-testnet.aiblocks.io/operations/1919197546291201/effects?cursor=1919197546291201-1&limit=10&order=desc"
    }
  },
  "_embedded": {
    "records": [
