...
title: All Payments
clientData:
  laboratoryUrl: https://www.aiblocks.io/laboratory/#explorer?resource=payments&endpoint=all
---
...
get made in the AiBlocks network.
...
curl "https://millennium-testnet.aiblocks.io/payments?limit=200"
```

```sh
# Retrieve a page of payments to occur immediately before the transaction
# specified by the paging token "1234".
curl "https://millennium-testnet.aiblocks.io/payments?cursor=1234&order=desc"
```
