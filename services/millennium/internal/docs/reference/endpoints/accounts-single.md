...
clientData:
  laboratoryUrl: https://www.aiblocks.io/laboratory/#explorer?resource=accounts&endpoint=single
replacement: https://developers.aiblocks.io/api/resources/accounts/single/
---
...
[trustlines](https://www.aiblocks.io/developers/learn/concepts/assets.html) this account
...
[authorization required](https://www.aiblocks.io/developers/guides/concepts/accounts.html#flags)
flag set, the trustline won't show up until account `B`
[allows](https://www.aiblocks.io/developers/guides/concepts/list-of-operations.html#allow-trust)
...
```sh
curl "https://millennium-testnet.aiblocks.io/accounts/GD42RQNXTRIW6YR3E2HXV5T2AI27LBRHOERV2JIYNFMXOBA234SWLQQB"
```
