...
replacement: https://developers.aiblocks.io/api/aggregations/paths/
---
...
```sh
curl "https://millennium-testnet.aiblocks.io/paths?destination_account=GAEDTJ4PPEFVW5XV2S7LUXBEHNQMX5Q2GM562RJGOQG7GVCE5H3HIB4V&source_account=GARSFJNXJIHO6ULUBK3DBYKVSIZE7SC72S5DYBCHU7DKL22UXKVD7MXP&destination_asset_type=native&destination_amount=20"
```
...
var destination_asset = AiBlocksSdk.Asset.native();
