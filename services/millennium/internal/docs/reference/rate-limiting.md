---
title: Rate Limiting
replacement: https://developers.aiblocks.io/api/introduction/rate-limiting/
---

In order to provide service stability, Millennium limits the number of requests a
...
Millennium is using [GCRA](https://brandur.org/rate-limiting#gcra) algorithm.

## Response headers for rate limiting

Every response from Millennium sets advisory headers to inform clients of their
