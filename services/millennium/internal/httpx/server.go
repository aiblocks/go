...
import (
	...
	"github.com/aiblocks/go/services/millennium/internal/render/sse"
...
// Server contains the http server related fields for millennium: the Router,
// rate limiter, etc.
type Server struct {
	Router         *Router
	...
	sm := &ServerMetrics{
		RequestDurationSummary: prometheus.NewSummaryVec(
			prometheus.SummaryOpts{
				Namespace: "millennium", Subsystem: "http", Name: "requests_duration_seconds",
