...
type ResumeTestTestSuite struct {
	...
	aiblocksCoreClient *mockAiBlocksCoreClient
	system            *system
}
...
func (s *ResumeTestTestSuite) SetupTest() {
	...
	s.aiblocksCoreClient = &mockAiBlocksCoreClient{}
	s.system = &system{
		...
		aiblocksCoreClient: s.aiblocksCoreClient,
	}
...
func (s *ResumeTestTestSuite) TearDownTest() {
	...
	s.aiblocksCoreClient.AssertExpectations(t)
}
