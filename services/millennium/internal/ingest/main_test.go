...
func TestNewSystem(t *testing.T) {
	config := Config{
		...
		HistoryArchiveURL:        "https://history.aiblocks.io/prd/core-live/core_live_001",
	}
...
type mockAiBlocksCoreClient struct {
	mock.Mock
}

func (m *mockAiBlocksCoreClient) SetCursor(ctx context.Context, id string, cursor int32) error {
	args := m.Called(ctx, id, cursor)
	return args.Error(0)
}

var _ aiblocksCoreClient = (*mockAiBlocksCoreClient)(nil)
