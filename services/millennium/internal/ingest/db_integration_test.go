...
func (s *DBTestSuite) SetupTest() {
	s.tt = test.Start(s.T())
	test.ResetMillenniumDB(s.T(), s.tt.MillenniumDB)
	...
	// go test -v -timeout 5m --tags=update  github.com/aiblocks/go/services/millennium/internal/ingest -run "^(TestUpdateSampleChanges)$"
	...
	sIface, err := NewSystem(Config{
		...
		HistorySession:           s.tt.MillenniumSession(),
