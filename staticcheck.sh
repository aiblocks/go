...
# Check millennium for unused exported symbols (relying on the fact that it should be self-contained)
staticcheck  -unused.whole-program -checks='U*' ./services/millennium/...
