...
func DeleteOfferOp(offerID int64, sourceAccount ...Account) (ManageSellOffer, error) {
	// It turns out AiBlocks core doesn't care about any of these fields except the amount.
	// However, Millennium will reject ManageSellOffer if it is missing fields.
	// Millennium will also reject if Buying == Selling.
...
// ManageSellOffer represents the AiBlocks manage offer operation. See
