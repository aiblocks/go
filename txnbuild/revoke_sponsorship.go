...
func (r *RevokeSponsorship) Validate() error {
	...
	case RevokeSponsorshipTypeAccount:
		...
		return validateAiBlocksPublicKey(*r.Account)
	case RevokeSponsorshipTypeTrustLine:
		if r.TrustLine == nil {
			return errors.New("Trustline can't be nil")
		}
		if err := validateAiBlocksPublicKey(r.TrustLine.Account); err != nil {
			return errors.Wrap(err, "invalid Account address")
		}
		if err := validateAiBlocksAsset(r.TrustLine.Asset); err != nil {
	...
	case RevokeSponsorshipTypeOffer:
		...
		if err := validateAiBlocksPublicKey(r.Offer.SellerAccountAddress); err != nil {
			return errors.Wrap(err, "invalid Seller account address")
		}
		return validateAiBlocksPublicKey(r.Offer.SellerAccountAddress)
	case RevokeSponsorshipTypeData:
		if r.Data == nil {
			return errors.New("Data can't be nil")
		}
		if err := validateAiBlocksPublicKey(r.Data.Account); err != nil {
			return errors.Wrap(err, "invalid Account address")
		}
	case RevokeSponsorshipTypeClaimableBalance:
		if r.ClaimableBalance == nil {
	...
	case RevokeSponsorshipTypeSigner:
		...
		if err := validateAiBlocksPublicKey(r.Signer.AccountID); err != nil {
			return errors.New("invalid Account address")
		}
		if err := validateAiBlocksSignerKey(r.Signer.SignerAddress); err != nil {
