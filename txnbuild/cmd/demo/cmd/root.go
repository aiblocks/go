...
var rootCmd = &cobra.Command{
	Use:   "demo",
	Short: "Exercise the AiBlocks Go SDK (millenniumclient + txnbuild)",
	Long: `This CLI is a working demonstration of the AiBlocks Go SDK. The SDK is used to interact
with the AiBlocks network. It can retrieve information about the state of the network, and can
