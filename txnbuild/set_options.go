...
// SetOptions represents the AiBlocks set options operation. See
...
// See https://www.aiblocks.io/developers/guides/concepts/accounts.html
...
// See https://www.aiblocks.io/developers/guides/concepts/multi-sig.html
...
// https://www.aiblocks.io/developers/guides/concepts/federation.html
...
func (so *SetOptions) Validate() error {
	...
	// Refactoring is out of the scope of this issue(https://github.com/aiblocks/go/issues/1041) so will leave as is for now.
	return nil
}
