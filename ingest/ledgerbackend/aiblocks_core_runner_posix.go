...
// Posix-specific methods for the AiBlocksCoreRunner type.

func (c *aiblocksCoreRunner) getPipeName() string {
...
func (c *aiblocksCoreRunner) start() (io.Reader, error) {
	...
	err = c.cmd.Start()
	if err != nil {
		return readFile, errors.Wrap(err, "error starting aiblocks-core")
	}
...
func (c *aiblocksCoreRunner) processIsAlive() bool {
	return c.cmd != nil &&
		c.cmd.Process != nil &&
