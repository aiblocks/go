...
// ledgerHeaderHistory is a helper struct used to unmarshall header fields from a aiblocks-core DB.
type ledgerHeaderHistory struct {
	Hash   xdr.Hash         `db:"ledgerhash"`
	Header xdr.LedgerHeader `db:"data"`
}

// ledgerHeader holds a row of data from the aiblocks-core `ledgerheaders` table.
...
// txHistory holds a row of data from the aiblocks-core `txhistory` table.
...
// txFeeHistory holds a row of data from the aiblocks-core `txfeehistory` table.
...
// scpHistory holds a row of data from the aiblocks-core `scphistory` table.
...
// upgradeHistory holds a row of data from the aiblocks-core `upgradehistory` table.
