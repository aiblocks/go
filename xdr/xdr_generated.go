...
//
//  AiBlocks-SCP.x
//  AiBlocks-ledger-entries.x
//  AiBlocks-ledger.x
//  AiBlocks-overlay.x
//  AiBlocks-transaction.x
//  AiBlocks-types.x
//
...
// AiBlocksValueType is an XDR Enum defines as:
//
...
//    };
//
type AiBlocksValueType int32

const (
	AiBlocksValueTypeAiBlocksValueBasic  AiBlocksValueType = 0
	AiBlocksValueTypeAiBlocksValueSigned AiBlocksValueType = 1
)

var aiblocksValueTypeMap = map[int32]string{
	0: "AiBlocksValueTypeAiBlocksValueBasic",
	1: "AiBlocksValueTypeAiBlocksValueSigned",
}

// ValidEnum validates a proposed value for this enum.  Implements
// the Enum interface for AiBlocksValueType
func (e AiBlocksValueType) ValidEnum(v int32) bool {
	_, ok := aiblocksValueTypeMap[v]
	return ok
}

// String returns the name of `e`
func (e AiBlocksValueType) String() string {
	name, _ := aiblocksValueTypeMap[int32(e)]
	return name
}

// MarshalBinary implements encoding.BinaryMarshaler.
func (s AiBlocksValueType) MarshalBinary() ([]byte, error) {
	b := new(bytes.Buffer)
	_, err := Marshal(b, s)
	return b.Bytes(), err
}
...
// UnmarshalBinary implements encoding.BinaryUnmarshaler.
func (s *AiBlocksValueType) UnmarshalBinary(inp []byte) error {
	_, err := Unmarshal(bytes.NewReader(inp), s)
	return err
}

var (
	_ encoding.BinaryMarshaler   = (*AiBlocksValueType)(nil)
	_ encoding.BinaryUnmarshaler = (*AiBlocksValueType)(nil)
)
...
// AiBlocksValueExt is an XDR NestedUnion defines as:
//
...
// SwitchFieldName returns the field name in which this union's
// discriminant is stored
func (u AiBlocksValueExt) SwitchFieldName() string {
	return "V"
}

// ArmForSwitch returns which field name should be used for storing
// the value for an instance of AiBlocksValueExt
func (u AiBlocksValueExt) ArmForSwitch(sw int32) (string, bool) {
	switch AiBlocksValueType(sw) {
	case AiBlocksValueTypeAiBlocksValueBasic:
		return "", true
	case AiBlocksValueTypeAiBlocksValueSigned:
		return "LcValueSignature", true
	}
	return "-", false
}

// NewAiBlocksValueExt creates a new  AiBlocksValueExt.
func NewAiBlocksValueExt(v AiBlocksValueType, value interface{}) (result AiBlocksValueExt, err error) {
	result.V = v
	switch AiBlocksValueType(v) {
	case AiBlocksValueTypeAiBlocksValueBasic:
		// void
	case AiBlocksValueTypeAiBlocksValueSigned:
...
// panicing if the value is not set.
func (u AiBlocksValueExt) MustLcValueSignature() LedgerCloseValueSignature {
...
// returning ok if the union's switch indicated the value is valid.
func (u AiBlocksValueExt) GetLcValueSignature() (result LedgerCloseValueSignature, ok bool) {
	armName, _ := u.ArmForSwitch(int32(u.V))
...
// MarshalBinary implements encoding.BinaryMarshaler.
func (s AiBlocksValueExt) MarshalBinary() ([]byte, error) {
	b := new(bytes.Buffer)
	_, err := Marshal(b, s)
	return b.Bytes(), err
}
...
// UnmarshalBinary implements encoding.BinaryUnmarshaler.
func (s *AiBlocksValueExt) UnmarshalBinary(inp []byte) error {
	_, err := Unmarshal(bytes.NewReader(inp), s)
	return err
}

var (
	_ encoding.BinaryMarshaler   = (*AiBlocksValueExt)(nil)
	_ encoding.BinaryUnmarshaler = (*AiBlocksValueExt)(nil)
)

// AiBlocksValue is an XDR Struct defines as:
//
...
//    };
//
type AiBlocksValue struct {
	TxSetHash Hash
	CloseTime TimePoint
	Upgrades  []UpgradeType `xdrmaxsize:"6"`
	Ext       AiBlocksValueExt
}

// MarshalBinary implements encoding.BinaryMarshaler.
func (s AiBlocksValue) MarshalBinary() ([]byte, error) {
	b := new(bytes.Buffer)
	_, err := Marshal(b, s)
	return b.Bytes(), err
}
...
// UnmarshalBinary implements encoding.BinaryUnmarshaler.
func (s *AiBlocksValue) UnmarshalBinary(inp []byte) error {
	_, err := Unmarshal(bytes.NewReader(inp), s)
	return err
}

var (
	_ encoding.BinaryMarshaler   = (*AiBlocksValue)(nil)
	_ encoding.BinaryUnmarshaler = (*AiBlocksValue)(nil)
)
...
// AiBlocksMessage is an XDR Union defines as:
//
...
// SwitchFieldName returns the field name in which this union's
// discriminant is stored
func (u AiBlocksMessage) SwitchFieldName() string {
	return "Type"
}

// ArmForSwitch returns which field name should be used for storing
// the value for an instance of AiBlocksMessage
func (u AiBlocksMessage) ArmForSwitch(sw int32) (string, bool) {
...
// NewAiBlocksMessage creates a new  AiBlocksMessage.
func NewAiBlocksMessage(aType MessageType, value interface{}) (result AiBlocksMessage, err error) {
	result.Type = aType
...
// panicing if the value is not set.
func (u AiBlocksMessage) MustError() Error {
	val, ok := u.GetError()
...
// returning ok if the union's switch indicated the value is valid.
func (u AiBlocksMessage) GetError() (result Error, ok bool) {
	armName, _ := u.ArmForSwitch(int32(u.Type))
...
// panicing if the value is not set.
func (u AiBlocksMessage) MustHello() Hello {
	val, ok := u.GetHello()
...
// returning ok if the union's switch indicated the value is valid.
func (u AiBlocksMessage) GetHello() (result Hello, ok bool) {
	armName, _ := u.ArmForSwitch(int32(u.Type))
...
// panicing if the value is not set.
func (u AiBlocksMessage) MustAuth() Auth {
	val, ok := u.GetAuth()
...
// returning ok if the union's switch indicated the value is valid.
func (u AiBlocksMessage) GetAuth() (result Auth, ok bool) {
	armName, _ := u.ArmForSwitch(int32(u.Type))
...
// panicing if the value is not set.
func (u AiBlocksMessage) MustDontHave() DontHave {
...
// returning ok if the union's switch indicated the value is valid.
func (u AiBlocksMessage) GetDontHave() (result DontHave, ok bool) {
	armName, _ := u.ArmForSwitch(int32(u.Type))
...
// panicing if the value is not set.
func (u AiBlocksMessage) MustPeers() []PeerAddress {
	val, ok := u.GetPeers()
...
// returning ok if the union's switch indicated the value is valid.
func (u AiBlocksMessage) GetPeers() (result []PeerAddress, ok bool) {
	armName, _ := u.ArmForSwitch(int32(u.Type))
...
// panicing if the value is not set.
func (u AiBlocksMessage) MustTxSetHash() Uint256 {
...
// returning ok if the union's switch indicated the value is valid.
func (u AiBlocksMessage) GetTxSetHash() (result Uint256, ok bool) {
	armName, _ := u.ArmForSwitch(int32(u.Type))
...
// panicing if the value is not set.
func (u AiBlocksMessage) MustTxSet() TransactionSet {
	val, ok := u.GetTxSet()
...
// returning ok if the union's switch indicated the value is valid.
func (u AiBlocksMessage) GetTxSet() (result TransactionSet, ok bool) {
	armName, _ := u.ArmForSwitch(int32(u.Type))
...
// panicing if the value is not set.
func (u AiBlocksMessage) MustTransaction() TransactionEnvelope {
...
// returning ok if the union's switch indicated the value is valid.
func (u AiBlocksMessage) GetTransaction() (result TransactionEnvelope, ok bool) {
	armName, _ := u.ArmForSwitch(int32(u.Type))
...
// panicing if the value is not set.
func (u AiBlocksMessage) MustSignedSurveyRequestMessage() SignedSurveyRequestMessage {
...
// returning ok if the union's switch indicated the value is valid.
func (u AiBlocksMessage) GetSignedSurveyRequestMessage() (result SignedSurveyRequestMessage, ok bool) {
	armName, _ := u.ArmForSwitch(int32(u.Type))
...
// panicing if the value is not set.
func (u AiBlocksMessage) MustSignedSurveyResponseMessage() SignedSurveyResponseMessage {
...
// returning ok if the union's switch indicated the value is valid.
func (u AiBlocksMessage) GetSignedSurveyResponseMessage() (result SignedSurveyResponseMessage, ok bool) {
	armName, _ := u.ArmForSwitch(int32(u.Type))
...
// panicing if the value is not set.
func (u AiBlocksMessage) MustQSetHash() Uint256 {
...
// returning ok if the union's switch indicated the value is valid.
func (u AiBlocksMessage) GetQSetHash() (result Uint256, ok bool) {
	armName, _ := u.ArmForSwitch(int32(u.Type))
...
// panicing if the value is not set.
func (u AiBlocksMessage) MustQSet() ScpQuorumSet {
	val, ok := u.GetQSet()
...
// returning ok if the union's switch indicated the value is valid.
func (u AiBlocksMessage) GetQSet() (result ScpQuorumSet, ok bool) {
	armName, _ := u.ArmForSwitch(int32(u.Type))
...
// panicing if the value is not set.
func (u AiBlocksMessage) MustEnvelope() ScpEnvelope {
...
// returning ok if the union's switch indicated the value is valid.
func (u AiBlocksMessage) GetEnvelope() (result ScpEnvelope, ok bool) {
	armName, _ := u.ArmForSwitch(int32(u.Type))
...
// panicing if the value is not set.
func (u AiBlocksMessage) MustGetScpLedgerSeq() Uint32 {
...
// returning ok if the union's switch indicated the value is valid.
func (u AiBlocksMessage) GetGetScpLedgerSeq() (result Uint32, ok bool) {
	armName, _ := u.ArmForSwitch(int32(u.Type))
...
// MarshalBinary implements encoding.BinaryMarshaler.
func (s AiBlocksMessage) MarshalBinary() ([]byte, error) {
	b := new(bytes.Buffer)
	_, err := Marshal(b, s)
	return b.Bytes(), err
}
...
// UnmarshalBinary implements encoding.BinaryUnmarshaler.
func (s *AiBlocksMessage) UnmarshalBinary(inp []byte) error {
	_, err := Unmarshal(bytes.NewReader(inp), s)
	return err
}

var (
	_ encoding.BinaryMarshaler   = (*AiBlocksMessage)(nil)
	_ encoding.BinaryUnmarshaler = (*AiBlocksMessage)(nil)
)
