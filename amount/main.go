...
// the format used internally to aiblocks-core.
//
// aiblocks-core represents asset "amounts" as 64-bit integers, but to enable
// fractional units of an asset, millennium, the client-libraries and other built
// on top of aiblocks-core use a convention, encoding amounts as a string of
// decimal digits with up to seven digits of precision in the fractional
// portion. For example, an amount shown as "101.001" in millennium would be
// represented in aiblocks-core as 1010010000.
package amount
...
// Parse parses the provided as a aiblocks "amount", i.e. a 64-bit signed integer
...
// ParseInt64 parses the provided as a aiblocks "amount", i.e. a 64-bit signed
...
// IntStringToAmount converts string integer value and converts it to aiblocks
