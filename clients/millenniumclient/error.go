...
func (herr Error) Error() string {
	return `millennium error: "` + herr.Problem.Title + `" - check millennium.Error.Problem for more information`
}
...
// This can be stored, or decoded in the AiBlocks Laboratory XDR viewer for example.
