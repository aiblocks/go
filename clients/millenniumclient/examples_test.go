...
func ExampleClient_Accounts() {
	...
	accountsRequest := millenniumclient.AccountsRequest{Signer: "GCLWGQPMKXQSPF776IU33AH4PZNOOWNAWGGKVTBQMIC5IMKUNP3E6NVU"}
...
func ExampleClient_AccountDetail() {
	client := millenniumclient.DefaultPublicNetClient
	accountRequest := millenniumclient.AccountRequest{AccountID: "GCLWGQPMKXQSPF776IU33AH4PZNOOWNAWGGKVTBQMIC5IMKUNP3E6NVU"}
...
func ExampleClient_Assets() {
	...
	assetRequest := millenniumclient.AssetRequest{ForAssetIssuer: "GCLWGQPMKXQSPF776IU33AH4PZNOOWNAWGGKVTBQMIC5IMKUNP3E6NVU"}
	...
	// all assets
	assetRequest = millenniumclient.AssetRequest{}
	asset, err = client.Assets(assetRequest)
	if err != nil {
		fmt.Println(err)
		return
...
func ExampleClient_Effects() {
	...
	effectRequest := millenniumclient.EffectRequest{ForAccount: "GCLWGQPMKXQSPF776IU33AH4PZNOOWNAWGGKVTBQMIC5IMKUNP3E6NVU"}
	...
	// all effects
	effectRequest = millenniumclient.EffectRequest{}
	effect, err = client.Effects(effectRequest)
	if err != nil {
		fmt.Println(err)
		return
...
func ExampleClient_NextEffectsPage() {
	client := millenniumclient.DefaultPublicNetClient
	// all effects
	effectRequest := millenniumclient.EffectRequest{Limit: 20}
...
func ExampleClient_NextLedgersPage() {
	client := millenniumclient.DefaultPublicNetClient
	// all ledgers
	ledgerRequest := millenniumclient.LedgerRequest{Limit: 20}
...
func ExampleClient_NextOffersPage() {
	client := millenniumclient.DefaultPublicNetClient
	// all offers
	offerRequest := millenniumclient.OfferRequest{ForAccount: "GAQHWQYBBW272OOXNQMMLCA5WY2XAZPODGB7Q3S5OKKIXVESKO55ZQ7C", Limit: 20}
...
func ExampleClient_NextOperationsPage() {
	client := millenniumclient.DefaultPublicNetClient
	// all operations
	operationRequest := millenniumclient.OperationRequest{Limit: 20}
...
func ExampleClient_NextTradeAggregationsPage() {
	...
	ta := millenniumclient.TradeAggregationRequest{
		StartTime:          testTime,
		EndTime:            testTime,
		Resolution:         millenniumclient.FiveMinuteResolution,
		BaseAssetType:      millenniumclient.AssetTypeNative,
		CounterAssetType:   millenniumclient.AssetType4,
...
func ExampleClient_NextTradesPage() {
	client := millenniumclient.DefaultPublicNetClient
	// all trades
	tradeRequest := millenniumclient.TradeRequest{Cursor: "123456", Limit: 30, Order: millenniumclient.OrderAsc}
...
func ExampleClient_NextTransactionsPage() {
	client := millenniumclient.DefaultPublicNetClient
	// all transactions
	transactionRequest := millenniumclient.TransactionRequest{Limit: 20}
...
func ExampleClient_Operations() {
	...
	opRequest := millenniumclient.OperationRequest{ForAccount: "GCLWGQPMKXQSPF776IU33AH4PZNOOWNAWGGKVTBQMIC5IMKUNP3E6NVU"}
	...
	// all operations
	opRequest = millenniumclient.OperationRequest{Cursor: "now"}
	ops, err = client.Operations(opRequest)
	if err != nil {
		fmt.Println(err)
		return
...
func ExampleClient_OrderBook() {
	client := millenniumclient.DefaultPublicNetClient
	// orderbook for an asset pair, e.g DLO/NGN
	obRequest := millenniumclient.OrderBookRequest{
		BuyingAssetType:    millenniumclient.AssetTypeNative,
		SellingAssetCode:   "USD",
		SellingAssetType:   millenniumclient.AssetType4,
...
func ExampleClient_SetMillenniumTimeout() {
	...
	// test user timeout
	client = client.SetMillenniumTimeout(30 * time.Second)
...
func ExampleClient_StreamEffects() {
	client := millenniumclient.DefaultTestNetClient
	// all effects
	effectRequest := millenniumclient.EffectRequest{Cursor: "760209215489"}
...
func ExampleClient_StreamLedgers() {
	...
	ledgerRequest := millenniumclient.LedgerRequest{}
...
func ExampleClient_StreamOffers() {
	client := millenniumclient.DefaultTestNetClient
	// offers for account
	offerRequest := millenniumclient.OfferRequest{ForAccount: "GAQHWQYBBW272OOXNQMMLCA5WY2XAZPODGB7Q3S5OKKIXVESKO55ZQ7C", Cursor: "1"}
...
func ExampleClient_StreamOperations() {
	client := millenniumclient.DefaultTestNetClient
	// operations for an account
	opRequest := millenniumclient.OperationRequest{ForAccount: "GAIH3ULLFQ4DGSECF2AR555KZ4KNDGEKN4AFI4SU2M7B43MGK3QJZNSR", Cursor: "760209215489"}
...
func ExampleClient_StreamOrderBooks() {
	client := millenniumclient.DefaultTestNetClient
	orderbookRequest := millenniumclient.OrderBookRequest{
		SellingAssetType:  millenniumclient.AssetTypeNative,
		BuyingAssetType:   millenniumclient.AssetType4,
		BuyingAssetCode:   "ABC",
...
func ExampleClient_StreamPayments() {
	client := millenniumclient.DefaultTestNetClient
	// all payments
	opRequest := millenniumclient.OperationRequest{Cursor: "760209215489"}
...
func ExampleClient_StreamTrades() {
	client := millenniumclient.DefaultTestNetClient
	// all trades
	tradeRequest := millenniumclient.TradeRequest{Cursor: "760209215489"}
...
func ExampleClient_StreamTransactions() {
	client := millenniumclient.DefaultTestNetClient
	// all transactions
	transactionRequest := millenniumclient.TransactionRequest{Cursor: "760209215489"}
...
func ExampleClient_SubmitFeeBumpTransactionWithOptions() {
	...
	result, err := client.SubmitFeeBumpTransactionWithOptions(
		feeBumpTx,
		millenniumclient.SubmitTxOpts{SkipMemoRequiredCheck: true},
	)
	if err != nil {
		fmt.Println(err)
	}
...
func ExampleClient_SubmitTransactionWithOptions() {
	...
	result, err := client.SubmitTransactionWithOptions(tx, millenniumclient.SubmitTxOpts{SkipMemoRequiredCheck: true})
	if err != nil {
		fmt.Println(err)
	}
...
func ExampleClient_SubmitTransactionWithOptions_skip_memo_required_check() {
	...
	result, err := client.SubmitTransactionWithOptions(tx, millenniumclient.SubmitTxOpts{
...
func ExampleClient_Trades() {
	client := millenniumclient.DefaultPublicNetClient
	// Find all trades
	tr := millenniumclient.TradeRequest{Cursor: "123456", Limit: 30, Order: millenniumclient.OrderAsc}
...
func ExampleClient_Transactions() {
	...
	txRequest := millenniumclient.TransactionRequest{ForAccount: "GCLWGQPMKXQSPF776IU33AH4PZNOOWNAWGGKVTBQMIC5IMKUNP3E6NVU"}
	...
	// all transactions
	txRequest = millenniumclient.TransactionRequest{Cursor: "now", Order: millenniumclient.OrderDesc}
	txs, err = client.Transactions(txRequest)
	if err != nil {
		fmt.Println(err)
		return
