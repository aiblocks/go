...
func TestOptionalAiBlocksFields(t *testing.T) {
	var val struct {
		F1 string `valid:"aiblocks_accountid,optional"`
		F2 string `valid:"optional,aiblocks_accountid"`
		F3 string `valid:"aiblocks_seed,optional"`
		F4 string `valid:"optional,aiblocks_accountid"`
	}
