...
func TestHandler(t *testing.T) {
    ...
    INSERT INTO people (id, name, domain) VALUES 
      ('GD2GJPL3UOK5LX7TWXOACK2ZPWPFSLBNKL3GTGH6BLBNISK4BGWMFBBG', 'scott', 'aiblocks.io'),
      ('GCYMGWPZ6NC2U7SO6SMXOP5ZLXOEC5SYPKITDMVEONLCHFSCCQR2J4S3', 'bartek', 'aiblocks.io');
  `)
	defer db.Close()
	...
	server.GET("/federation").
		...
		Status(http.StatusOK).
		JSON().Object().
		ContainsKey("aiblocks_address").
		ValueEqual("aiblocks_address", "scott*aiblocks.io")
