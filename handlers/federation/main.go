// Package federation provides a pluggable handler that satisfies the AiBlocks
...
type Driver interface {
	...
	// federation request to lookup a `Record` using the provided aiblocks address.
...
// conform to the AiBlocks federation protocol.  This handler should be added to
...
type ReverseSQLDriver struct {
	...
	// aiblocks account id to lookup, such as
