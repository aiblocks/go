# Get state from aiblocks-core DB, colums match CSV printer
...
echo "Fetching accounts from aiblocks-core DB..."
...
echo "Fetching accountdata from aiblocks-core DB..."
...
echo "Fetching offers from aiblocks-core DB..."
...
echo "Fetching trustlines from aiblocks-core DB..."
