...
A Recovery Signer is a server that can help a user regain control of a AiBlocks
...
Flags:
      ...
      --signing-key string           AiBlocks signing key(s) used for signing transactions comma separated (first key is preferred signer) (will be deprecated with per-account keys in the future) (SIGNING_KEY)
```
...
[SEP-30]: https://github.com/aiblocks/aiblocks-protocol/blob/600c326b210d71ee031d7f3a40ca88191b4cdf9c/ecosystem/sep-0030.md
