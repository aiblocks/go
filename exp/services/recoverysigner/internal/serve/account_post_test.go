	...
	"identities": [
		{
			"role": "owner",
			"auth_methods": [
				{ "type": "aiblocks_address", "value": "GBF3XFXGBGNQDN3HOSZ7NVRF6TJ2JOD5U6ELIWJOOEI6T5WKMQT2YSXQ" },
...
func TestAccountPost_newWithRoleOwnerContentTypeForm(t *testing.T) {
	...
	reqValues.Set("identities.0.auth_methods.0.type", "aiblocks_address")
...
func TestAccountPost_newWithRolesSenderReceiverContentTypeJSON(t *testing.T) {
	...
	"identities": [
		...
		},
		{
			"role": "receiver",
			"auth_methods": [
				{ "type": "aiblocks_address", "value": "GB5VOTKJ3IPGIYQBJ6GVJMUVEAIYGXZUJE4WYLPBJSHOTKLZTETBYOBI" },
...
func TestAccountPost_newWithRolesSenderReceiverContentTypeForm(t *testing.T) {
	...
	reqValues.Set("identities.1.auth_methods.0.type", "aiblocks_address")
