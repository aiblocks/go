...
import (
	...
	"github.com/aiblocks/go/exp/support/jwtkey"
...
func TestToken_formInputSuccess(t *testing.T) {
	...
	millenniumClient := &millenniumclient.MockClient{}
	millenniumClient.
		On("AccountDetail", millenniumclient.AccountRequest{AccountID: account.Address()}).
		Return(
			millennium.Account{
