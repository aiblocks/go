...
SEP-10 defines an endpoint for authenticating a user in possession of a AiBlocks
account using their AiBlocks account as credentials. This implementation is a
...
Flags:
      ...
      --millennium-url string                 Millennium URL used for looking up account details (MILLENNIUM_URL) (default "https://millennium-testnet.aiblocks.io/")
      ...
      --signing-key string                 AiBlocks signing key(s) used for signing transactions comma separated (first key is used for signing, others used for verifying challenges) (SIGNING_KEY)
```

[SEP-10]: https://github.com/aiblocks/aiblocks-protocol/blob/28c636b4ef5074ca0c3d46bbe9bf0f3f38095233/ecosystem/sep-0010.md
